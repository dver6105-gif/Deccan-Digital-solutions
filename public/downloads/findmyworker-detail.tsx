...
import type { Lang } from "@/lib/apps/findmyworker";
import { findMyWorkerContent, findMyWorkerMeta } from "@/lib/apps/findmyworker";

export function FindMyWorkerDetail() {
  const [lang, setLang] = useState<Lang>("en");
  const content = findMyWorkerContent[lang];
  const meta = findMyWorkerMeta;
  ...
  return (
    <main>
      ...
      <section className="bg-white py-14">
        <div className="container">
          <h2 className="text-xl font-bold tracking-tight">
            {lang === "en" ? "Installation Guide (APK)" : "इन्स्टॉलेशन मार्गदर्शक (APK)"}
          </h2>
      ...
      <section className="container py-14">
        ...
        <p className="mt-10 text-sm text-muted-foreground">{content.developedBy}</p>
      </section>
    </main>
  );
}
